...
export const GridProvider = ({ children }: { children: ReactNode }) => {
  ...
  return (
    <GridContext.Provider value={{
      walls, setWalls, terrainFactors, setTerrainFactors, elevations, setElevations,
      robotNode, setRobotNode, destinationNode, setDestinationNode,
      activeBrush, setActiveBrush, elevationBrushValue, setElevationBrushValue
    }}>
      {children}
